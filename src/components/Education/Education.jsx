      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            {/* Content Box */}
            <div
              className={`w-full sm:max-w-md bg-gray-900 border border-white p-6 sm:p-8 rounded-2xl shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] backdrop-blur-md transition-transform duration-300 hover:scale-105 ${
                index % 2 === 0
                  ? "sm:ml-[calc(50%+2rem)]"
